...
import 'package:network_practice/turtleAnimation.dart';
            ...
            children: <Widget>[
              ...
              Expanded(
                ...
                children: [
                  ...
                  TextButton(
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=> TurtleAnimation()));
                      },style: AppDecorations.buttonStyle,
                      child: const Text("hello turtle animation")),
